...
namespace Util
{
	...
	*/
	...
	std::vector<CollisionFocusObject> FindCollisionObjectListByOverride(RE::NiNode* nodeIn, ObjectOverride objOverride);
	...
	void ForEachReferenceInRange(RE::NiPoint3 originPos, float a_radius, std::function<RE::BSContainer::ForEachResult(RE::TESObjectREFR* a_ref)> a_callback);
	...
	//void CellForEachReference(RE::TESObjectCELL* cell, std::function<RE::BSContainer::ForEachResult(RE::TESObjectREFR&)> a_callback);
	void CellForEachReferenceInRange(RE::TESObjectCELL* cell, const RE::NiPoint3& a_origin, float a_radius, std::function<RE::BSContainer::ForEachResult(RE::TESObjectREFR*)> a_callback);
	...
	void EnableControlFlag(RE::ControlMap::UEFlag flag);
	void DisableControlFlag(RE::ControlMap::UEFlag flag);
	uint32_t* GetControlsEnabledPtr();
