...
static inline char* duplicateStringValue(const char* value, size_t length) {
  ...
  auto newString = static_cast<char*>(std::malloc(length + 1));
...
static inline char* duplicateAndPrefixStringValue(const char* value,
  ...
  auto newString = static_cast<char*>(std::malloc(actualLength));
  if (newString == nullptr) {
...
static inline void releasePrefixedStringValue(char* value) { std::free(value); }
static inline void releaseStringValue(char* value, unsigned) { std::free(value); }
